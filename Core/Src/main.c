...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, EN_LED1_Pin|EN_LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : EN_LED1_Pin EN_LED2_Pin */
  GPIO_InitStruct.Pin = EN_LED1_Pin|EN_LED2_Pin;
